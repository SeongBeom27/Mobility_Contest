...
def mark_img(img, blue_threshold=50, green_threshold=130, red_threshold=130): # 흰색 차선 찾기
...
# 사다리꼴 모형의 Points
#vertices = np.array([[(0,0),(0, 223), (223, 0), (223,223)]], dtype=np.int32)
vertices = np.array([[(0,height),(width/2-65, height/2+30), (width/2+100, height/2+30), (width,height)]], dtype=np.int32)
roi_img = region_of_interest(image, vertices, (0,255,0)) # vertices에 정한 점들 기준으로 ROI 이미지 생성
